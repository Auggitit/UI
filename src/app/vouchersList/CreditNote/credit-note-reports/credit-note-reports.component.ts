...
@Component({
  ...
  templateUrl: './credit-note-reports.component.html',
  styleUrls: ['./credit-note-reports.component.scss'],
})
export class CreditNoteReportsComponent implements OnInit, OnDestroy {
  ...
  downloadAsPDF() {
    if (this.form.value.SelectSaveOptions === 0) {
      ...
      let element = document.getElementById('creditNoteReportsTable')!;
