...
@Component({
  ...
  styleUrls: ['./debit-note-report.component.scss'],
})
export class DebitNoteReportComponent implements OnInit, OnDestroy {
  ...
  downloadAsPDF() {
    if (this.form.value.SelectSaveOptions === 0) {
      ...
      let element = document.getElementById('debitNoteReportsTable')!;
