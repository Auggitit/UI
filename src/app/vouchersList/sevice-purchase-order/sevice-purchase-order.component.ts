    ...
    this.cardsDetails = [
      {
        ...
        title: 'Total Service Purchase Order',
      ...
      },
      {
        ...
        title: 'Completed Service Purchase Order',
      ...
      },
      {
        ...
        title: 'Pending Service Purchase Order',
      ...
      {
        icon: 'bi bi-cart-x',
        title: 'Cancelled Service Purchase Order',
      ...
      {
        icon: 'bi bi-wallet',
        title: 'Service Purchase Order Value',
        count: Math.round(
          updatedValue.reduce(
