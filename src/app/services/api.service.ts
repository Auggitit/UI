...
export class ApiService {
  ...
  update_CompanyData(id: any, postdata: any): Observable<any> {
    return this.http.put<any>(this.URL + 'api/mCompanies/' + id, postdata).pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  delete_CompanyData(id: any): Observable<any> {
    return this.http.delete<any>(this.URL + 'api/mCompanies/' + id).pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  get_CompanyData() {
    ...
    return this.http.get<any>(this.URL + 'api/mCompanies').pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  get_CompanyDataWithID(id: any) {
    return this.http.get<any>(this.URL + 'api/mCompanies/' + id).pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  Update_LedgerGroup(id: any, postdata: any): Observable<any> {
    return this.http
      .put<any>(this.URL + 'api/mLedgerGroups/' + id, postdata)
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  get_LedgerGroupwithID(id: any) {
    return this.http.get<any>(this.URL + 'api/mLedgerGroups/' + id).pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  get_LedgerGroup_MaxID() {
    return this.http.get<any>(this.URL + 'api/mLedgerGroups/getMaxID').pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  delete_LedgerGroup(id: any): Observable<any> {
    return this.http.delete<any>(this.URL + 'api/mLedgerGroups/' + id).pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  Update_LedgerData(id: any, postdata: any): Observable<any> {
    return this.http.put<any>(this.URL + 'api/mLedgers/' + id, postdata).pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  get_LedgerDataWithID(id: any) {
    return this.http.get<any>(this.URL + 'api/mLedgers/' + id).pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  getMaxLedgerID() {
    return this.http.get<any>(this.URL + 'api/mLedgers/getMaxLedgerID').pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  getCustomersOnly() {
    return this.http.get<any>(this.URL + 'api/mLedgers/getCustomers').pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  getVendorsOnly() {
    return this.http.get<any>(this.URL + 'api/mLedgers/getVendors').pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  getOtherLedgers() {
    return this.http.get<any>(this.URL + 'api/mLedgers/getOthers').pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  get_CountryDataWithID(id: any) {
    return this.http.get<any>(this.URL + 'api/mCountries/' + id).pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  get_StateDataWithID(id: any) {
    return this.http.get<any>(this.URL + 'api/mStates/' + id).pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  get_CategoryData() {
    return this.http.get<any>(this.URL + 'api/mCategories').pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  get_CategoryDataWithID(id: any) {
    return this.http.get<any>(this.URL + 'api/mCategories/' + id).pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  get_CategoryDataWithName(name: any) {
    return this.http
      .get<any>(this.URL + 'api/mCategories/checkDuplicate?name=' + name)
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  get_GroupData() {
    return this.http.get<any>(this.URL + 'api/mItemgroups').pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  get_GroupDataWithID(id: any) {
    return this.http.get<any>(this.URL + 'api/mItemgroups/' + id).pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  get_GroupDataWithName(name: any) {
    return this.http
      .get<any>(this.URL + 'api/mItemgroups/checkDuplicate?name=' + name)
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  get_UOMData() {
    return this.http.get<any>(this.URL + 'api/mUoms').pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  get_UOMDataWithID(id: any) {
    return this.http.get<any>(this.URL + 'api/mUoms/' + id).pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  get_UOMDataWithName(name: any) {
    return this.http
      .get<any>(this.URL + 'api/mUoms/checkDuplicate?name=' + name)
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  get_ItemData() {
    return this.http.get<any>(this.URL + 'api/mItems/getItems').pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  get_ItemDataWithID(id: any) {
    return this.http.get<any>(this.URL + 'api/mItems/' + id).pipe(
      map((res: any) => {
        return res;
      })
    );
  ...
  get_ItemDataWithName(name: any) {
    return this.http
      .get<any>(this.URL + 'api/mItems/checkDuplicate?name=' + name)
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  get_PurchaseVoucherType(vch: any) {
    return this.http
      .get<any>(this.URL + 'api/mVoucherTypes/getVoucherTypes?vch=' + vch)
      .pipe(
        map((res: any) => {
          return res;
        })
  ...
  get_DefaultAccounts() {
    return this.http.get<any>(this.URL + 'api/defaultaccounts').pipe(
      map((res: any) => {
        return res;
      })
    );
