...
@Component({
  selector: 'app-service-grn-report',
  templateUrl: './service-grn-report.component.html',
  styleUrls: ['./service-grn-report.component.scss'],
})
export class ServiceGrnReportComponent implements OnInit, OnDestroy {
  ...
  downloadAsPDF() {
    if (this.form.value.SelectSaveOptions === 0) {
      ...
      html2canvas(data, { scale: 2 }).then((canvas) => {
        ...
        pdf.text(
          ' Service Goods Receipt Note (GRN) Summary(' + timeDuration + ')',
          200,
          50
        );
        ...
        pdf.setLineWidth(2);
        pdf.text(
          'Recent Service Goods Receipt Note (GRN)',
          240,
          (topValue += 50)
        );
        pdf.setFontSize(12);
      ...
      wb.Props = {
        Title: 'Service Goods Receipt Note (GRN) Report',
      };
      ...
      XLSX.utils.sheet_add_aoa(
        ws,
        [['Service Goods Receipt Note (GRN) Summary']],
        {
          origin: 'E1',
        }
      );
