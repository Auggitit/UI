...
//#endregion
@Component({
  selector: 'app-grnserviceupdate',
  templateUrl: './grnserviceupdate.component.html',
  styleUrls: ['./grnserviceupdate.component.scss'],
})
export class GrnserviceupdateComponent implements OnInit {
  //#region constructor
  constructor(
    public sgrnapi: GrnserviceService,
    ...
    private gstdataapi: GstdataService
  ) {}
  //#endregion
  //#region view
  ...
  ngOnInit(): void {
    ...
    this.invno = id + '/' + fy + '/' + 'SGRN';

    this.loadProducts().then((res) => {
      this.loadSavedAccounts().then((res) => {
        this.loadDefalutAccounts().then((res) => {
          this.loadDefControl().then((res) => {
            this.loadPurchaseAccounts().then((res) => {
              this.loadgst().then((res) => {
  ...
  loadVendors() {
    return new Promise((resolve, reject) => {
      this.sgrnapi.getVendors().subscribe((res) => {
  ...
  vendorChanged(event: any, data: any) {
    if (event.isUserInput == true) {
      this.sgrnapi.getPendingPoListDetails(data.LedgerCode).subscribe((res) => {
  ...
  loadSavedSdef() {
    this.sgrnapi.getCusList(this.invno).subscribe((res) => {
      this.sdefload = res;
  ...
  loadGRNDetails() {
    return new Promise((resolve) => {
      this.emprtyGrid();
      this.sgrnapi.get_GRNDetails(this.invno).subscribe((res) => {
  ...
  loadGRN() {
    return new Promise((resolve) => {
      this.sgrnapi.get_GRN(this.invno).subscribe((res) => {
        console.log(res);
  ...
  loadLedger() {
    return new Promise((resolve) => {
      this.findGst();
      this.emptyGstGrid();
      this.sgrnapi.get_Ledger(this.invno.toString()).subscribe((res) => {
  ...
  loadPurchaseAccounts() {
    return new Promise((resolve) => {
      this.sgrnapi.getPurchaseAccounts().subscribe((res) => {
  ...
  loadDefalutAccounts() {
    return new Promise((resolve) => {
      this.sgrnapi.getDefaultAccounts().subscribe((res) => {
  ...
  loadSavedAccounts() {
    return new Promise((resolve) => {
      this.sgrnapi.getSavedAccounts().subscribe((res) => {
        //  console.log(res);
  ...
  deleteExistingGRN() {
    return new Promise((resolve) => {
      this.sgrnapi
        .Delete_GRNDetails(this.invno, this.vchtype, this._branch, this._fy)
        .subscribe((res) => {
          this.sgrnapi
            .Delete_GRN(this.invno, this.vchtype, this._branch, this._fy)
            .subscribe((res) => {
              this.sgrnapi
                .Delete_CusdefFields(
                  this.invno,
  ...
  insertCustomFields() {
    return new Promise((resolve) => {
      ...
      this.sgrnapi.insertCusFields(this.cusFields).subscribe((res) => {});
      resolve({ action: 'success' });
    });
  }
  //#endregion
  ...
  insertGrnDetails() {
    return new Promise((resolve) => {
      ...
      this.sgrnapi.Insert_Bulk_GRN_Details(this.dataSource).subscribe((res) => {
        resolve({ action: 'success' });
      });
    });
  }
  ...
  insertGrn() {
    return new Promise((resolve) => {
      ...
      this.sgrnapi.Insert_GRN(postData).subscribe((res) => {
        resolve({ action: 'success' });
      });
    });
  }
  ...
  insertOverDue() {
    return new Promise((resolve) => {
      ...
      this.sgrnapi.Insert_Overdue(postdata).subscribe((res) => {
        resolve({ action: 'success' });
      });
    });
  }
