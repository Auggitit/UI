...
import {
  ...
  igstaccounts,
  iprodutcs,
} from '../../povch/po/po.component';
import { gstdata } from '../../grnservicevch/grnservice/grnservice.component';
//#endregion
...
export class GrnComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // this.childComponent.loadVendors();
  }
  ...
  loadGRN(pono: any) {
    return new Promise((resolve) => {
      this.poapi.get_PO(pono).subscribe((res) => {
    ...
    return new Promise((resolve) => {
      for (let i = 0; i < this.listData.filteredData.length; i++) {
        ...
        var postdata = {
          ...
          CGST_Val: parseFloat(cgstvalue).toFixed(2)
            ? parseFloat(cgstvalue)
            : 0,
          SGST_Val: parseFloat(sgstvalue).toFixed(2)
