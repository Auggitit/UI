...
export class ServicesaleComponent implements OnInit {
  ...
  callChangeVoucherType() {
    // let dialogRef = this.dialog.open(SaleVtypeComponent,
    // {
    // });
    // dialogRef.afterClosed().subscribe(result=>{
  ...
  onQtyKeydown(event: any, rowindex: any) {
    ...
    if (this.tpRate == '' || this.tpRate == null || this.tpRate == undefined) {
      this.tpRate = '0';
    }
    if (this.pkRate == '' || this.pkRate == null || this.pkRate == undefined) {
      this.pkRate = '0';
    }
    if (
      this.insRate == '' ||
      this.insRate == null ||
      this.insRate == undefined
    ) {
      this.insRate = '0';
    }
  ...
  onPackingRateKeydown(event: any, rowindex: any) {
    ...
    if (packing == '' || packing == null || packing == undefined) {
      packing = '0';
    }
    this.onCalculation(
      totqty,
  ...
  onInsurenceRateKeydown(event: any, rowindex: any) {
    ...
    if (insurence == '' || insurence == null || insurence == undefined) {
      insurence = '0';
    }
    this.onCalculation(
      totqty,
  ...
  onCalculation(
    ...
    var totalrate =
      ...
      (parseFloat(transport) + parseFloat(packing) + parseFloat(insurence));
  ...
  applyTransportValue(event: any) {
    ...
    for (let i = 0; i < this.listData.filteredData.length; i++) {
      ...
      if (_qtymt == '' || _qtymt == null || _qtymt == undefined) {
        _qtymt = '0';
      }
    ...
    for (let i = 0; i < this.listData.filteredData.length; i++) {
      ...
      this.listData.filteredData[i].transport = (totqty * eachRowValue).toFixed(
        2
      );
  ...
  applyTransportRate(event: any) {
    ...
    for (let i = 0; i < this.listData.filteredData.length; i++) {
      totTransport =
        totTransport + parseFloat(this.listData.filteredData[i].transport);
    }
  ...
  applyPackingValue(event: any) {
    ...
    for (let i = 0; i < this.listData.filteredData.length; i++) {
      ...
      totqty = parseFloat(qty);
      var rate = this.listData.filteredData[i].rate;
      this.listData.filteredData[i].packing = (totqty * eachRowValue).toFixed(
        2
      );
      var disc = this.listData.filteredData[i].disc;
      var gst = this.listData.filteredData[i].gst;
  ...
  applyPackingRate(event: any) {
    ...
    for (let i = 0; i < this.listData.filteredData.length; i++) {
      totPacking =
        totPacking + parseFloat(this.listData.filteredData[i].packing);
    }
  ...
  applyInsurenceValue(event: any) {
    ...
    for (let i = 0; i < this.listData.filteredData.length; i++) {
      ...
      totqty = parseFloat(qty);
      var rate = this.listData.filteredData[i].rate;
      this.listData.filteredData[i].insurence = (totqty * eachRowValue).toFixed(
        2
      );
      var disc = this.listData.filteredData[i].disc;
      var gst = this.listData.filteredData[i].gst;
  ...
  applyInsurenceRate(event: any) {
    ...
    for (let i = 0; i < this.listData.filteredData.length; i++) {
      totinsurence =
        totinsurence + parseFloat(this.listData.filteredData[i].insurence);
    }
  ...
  calculate() {
    ...
    var gstAmount = 0.0;
    this.nettotal = 0.0;
    if (this.tdsper == undefined) {
      this.tdsper = 0.0;
    }
    if (this.tdsper == '') {
      this.tdsper = 0.0;
    }
    if (this.roundedoff == undefined) {
      this.roundedoff = 0.0;
    }
    if (this.roundedoff == '') {
      this.roundedoff = 0.0;
    ...
    for (let i = 0; i < this.listData.filteredData.length; i++) {
      this.subtotal =
        this.subtotal + parseFloat(this.listData.filteredData[i].subtotal);
      ...
      this.disctotal =
        this.disctotal + parseFloat(this.listData.filteredData[i].discvalue);
      ...
      if (this.vendorstatecode == '33') {
        ...
        if (parseFloat(__gst) == 0) {
          ...
          cgst0 = cgst0 + 0;
          sgst0 = sgst0 + 0;
          var fac = this.defaultAccounts.find(
          ...
          var fas = this.defaultAccounts.find(
        ...
        if (parseFloat(__gst) == 0) {
          var KEY = 'IGST 0';
          igst0 = igst0 + 0;
          var fa = this.defaultAccounts.find(
  ...
  calculateall() {
    ...
    for (let i = 0; i < this.acclistData.filteredData.length; i++) {
      netTotal =
        netTotal + parseFloat(this.acclistData.filteredData[i].accvalue);
    }
    ...
    if (parseFloat(this.tcsrate) > 0) {
      ...
      if (parseFloat(this.tcsrate) > 0) {
        ...
        this.closingtotal = (
          parseFloat(this.nettotal) + parseFloat(tcsAmout)
        ).toFixed(2);
      ...
      if (parseFloat(this.tcsvalue) > 0) {
        ...
        this.closingtotal =
          parseFloat(this.nettotal) + parseFloat(this.tcsvalue);
        var per = (
  ...
  getTotal() {
    ...
    for (let i = 0; i < this.listData.filteredData.length; i++) {
      ...
      this.totQtyMT =
        this.totQtyMT + parseFloat(this.listData.filteredData[i].qtymt);
      this.totSub =
      ...
      for (let i = 0; i < this.acclistData.filteredData.length; i++) {
        setTimeout(() => {
          var postdata = {
            ...
            vchtype: this.vchtype,
            entrytype: 'CR',
            cr: parseFloat(this.acclistData.filteredData[i].accvalue).toFixed(
              2
            ),
            dr: 0,
            rCreatedDateTime: new Date(),
