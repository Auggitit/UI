...
export class SalesComponent implements OnInit {
  ...
  private dialogRef!: MatDialogRef<SalesvtypeComponent>;
  ...
  callChangeVoucherType() {
    this.dialogRef = this.dialog.open(SalesvtypeComponent, {});
  ...
  showPendingSODetails() {
    ...
    dialogRef.afterClosed().subscribe((result) => {
      ...
      this.salerefname = result.saleref;
  ...
  vendorChanged(event: any, data: any) {
    if (event.isUserInput == true) {
      ...
      this.salesapi
        .getPendingSOListDetails(data.LedgerCode, this.branch, this.fy)
        .subscribe((res) => {
